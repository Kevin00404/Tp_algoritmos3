...
public class Pokebola {
    ...
    public Map<String, Pokemon> getPokebola() {
        return dicc;
    }
    public static void mostrarPokemones(Map<String, Pokemon> dicc){
        for (Map.Entry<String, Pokemon> entry : dicc.entrySet()) {
            String clave = entry.getKey();
            Pokemon valor = entry.getValue();
