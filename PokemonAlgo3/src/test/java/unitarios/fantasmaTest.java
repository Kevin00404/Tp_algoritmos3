...
public class fantasmaTest {
        ...
        public void testMultiplicador_danio_tipo3() {
            assertEquals(elemento.multiplicador_danio_tipo(new Fantasma()), 2.0, 0.1);
        }
        ...
        public void testMultiplicador_danio_tipo6() {
            assertEquals(elemento.multiplicador_danio_tipo(new Lucha()), 0.0, 0.1);
        }

        @Test
        public void testMultiplicador_danio_tipo7() {
            assertEquals(elemento.multiplicador_danio_tipo(new Normal()), 0.0, 0.1);
        }
