...
public class tierraTest {
    ...
    public void testMultiplicador_danio_tipo2() {
        assertEquals(elemento.multiplicador_danio_tipo(new Electrico()), 0.0, 0.1);
    }
    ...
    public void testMultiplicador_danio_tipo10() {
        assertEquals(elemento.multiplicador_danio_tipo(new Roca()), 0.5, 0.1);
    }
