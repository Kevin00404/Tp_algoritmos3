...
public class plantaTest {
    ...
    public void mixElement() {
        Element elemento = new Planta();
        Double resultado = elemento.mixElement(elemento);
        assertEquals(resultado, 0.5, 0.01);
    }
    ...
    public void testMultiplicador_danio_tipo() {
        assertEquals(elemento.multiplicador_danio_tipo(new Agua()), 0.5, 0.1);
    }

    @Test
    public void testMultiplicador_danio_tipo1() {
        assertEquals(elemento.multiplicador_danio_tipo(new Bicho()), 2.0, 0.1);
    }

    @Test
    public void testMultiplicador_danio_tipo2() {
        assertEquals(elemento.multiplicador_danio_tipo(new Electrico()), 0.5, 0.1);
    }
    ...
    public void testMultiplicador_danio_tipo6() {
        assertEquals(elemento.multiplicador_danio_tipo(new Lucha()), 1.0, 0.1);
    }
